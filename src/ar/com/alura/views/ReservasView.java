...
//Activa el evento, después del usuario seleccionar las fechas se debe calcular el valor de la reserva
	...
	public void guardarReserva() {
		try {
			...
			Reserva reserva = new Reserva(java.sql.Date.valueOf(fechaE),java.sql.Date.valueOf(fechaS),Integer.parseInt(ReservasView.txtValor.getText()) , 
					txtFormaPago.getSelectedItem().toString());
			reservaController.guardar(reserva);
			JOptionPane.showConfirmDialog(contentPane,"Registro Creado y Guardado" );
		}catch (Exception e) {
